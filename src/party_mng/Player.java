...
public class Player {
	...
	public Player(Session sess, JSONObject json) throws JSONFormatException{
		...
		this.answers = new String[ResourceManager.entryNo];
		
		this.rating = new Integer[ResourceManager.entryNo];
	...
	public Player(Player mother){
		this.webSocketSession = mother.webSocketSession;
		this.name = mother.name;
		this.deviceID = mother.deviceID;
	 ...
	 * @param json
	 */
	public void sendAsyncJSONFile(JSONObject json){
